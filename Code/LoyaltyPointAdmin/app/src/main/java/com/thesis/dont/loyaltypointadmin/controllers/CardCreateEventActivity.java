...
public class CardCreateEventActivity extends ActionBarActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton = (ButtonRectangle) findViewById(R.id.createEventBtn);
        ...
        iconChooser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(CardCreateEventActivity.this, CropImageActivity.class);
