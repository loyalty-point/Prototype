...
jstring Java_com_thesis_dont_loyaltypointadmin_models_ShopModel_getGetNewestUserEventAward(JNIEnv* env, jobject thiz)
{
    return (*env)->NewStringUTF(env, "http://104.155.233.34/web_service/admin_shop/get_newest_user_event_award.php");
}
