...
jstring Java_com_thesis_dont_loyaltypointadmin_models_CardModel_getEditEvent(JNIEnv* env, jobject thiz)
{
    return (*env)->NewStringUTF(env, "http://104.155.233.34/web_service/card/edit_event.php");
}

jstring Java_com_thesis_dont_loyaltypointadmin_models_CardModel_getCreateAward(JNIEnv* env, jobject thiz)
{
    return (*env)->NewStringUTF(env, "http://104.155.233.34/web_service/card/create_award.php");
}

jstring Java_com_thesis_dont_loyaltypointadmin_models_CardModel_getEditAward(JNIEnv* env, jobject thiz)
{
