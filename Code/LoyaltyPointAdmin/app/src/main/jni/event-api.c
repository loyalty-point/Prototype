...
{
    return (*env)->NewStringUTF(env, "http://104.155.233.34/web_service/event/add_event.php");
}

jstring Java_com_thesis_dont_loyaltypointadmin_models_EventModel_getGetListEvents(JNIEnv* env, jobject thiz)
{
    return (*env)->NewStringUTF(env, "http://104.155.233.34/web_service/event/get_list_events.php");
}

jstring Java_com_thesis_dont_loyaltypointadmin_models_EventModel_getEditEvent(JNIEnv* env, jobject thiz)
{
    return (*env)->NewStringUTF(env, "http://104.155.233.34/web_service/event/edit_event.php");
}

jstring Java_com_thesis_dont_loyaltypointadmin_models_EventModel_getCalculatePoint(JNIEnv* env, jobject thiz)
{
    return (*env)->NewStringUTF(env, "http://104.155.233.34/web_service/event/calculate_point.php");
}
