...
jstring Java_com_thesis_dont_loyaltypointadmin_models_UserModel_getGetListHistoryCard(JNIEnv* env, jobject thiz)
{
    return (*env)->NewStringUTF(env, "http://104.155.233.34/web_service/admin_card/get_list_history.php");
}
