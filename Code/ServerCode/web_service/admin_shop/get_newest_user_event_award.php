...
$query = "select * from customer_shop where shop_id='".$shop_id."' and isAccepted != '0' limit 3";
$query_exec = mysqli_query($localhost, $query);
$user_result = "";
...
$query = "select * from event where shop_id = '" . $shop_id . "' ORDER BY id DESC limit 3";
$query_exec = mysqli_query($localhost, $query);
$event_result = "";
while($row = mysqli_fetch_array($query_exec)){
...
$query = "select * from award where shopID = '" . $shop_id . "' ORDER BY id DESC limit 3";
$query_exec = mysqli_query($localhost, $query);
$award_result = "";
while($row = mysqli_fetch_array($query_exec)){
