...
$query = "select * from history where username='".$customer_users['username']."' and id in (select history_id from history_card_shop where card_id = '".$cardID."' and shop_id = '".$shopID."') order by time desc";
$query_exec = mysqli_query($localhost, $query);
