 ...
 * on 2015-03-23 at 11:50:40 UTC 
 * Modify at your own risk.
 */

package com.thesis.loyaltypointsystem.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<com.thesis.loyaltypointsystem.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.thesis.loyaltypointsystem.backend.myApi.model.MyBean.class);
  ...
  /**
   * Create a request for the method "uploadImage".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   ...
   * @return the request
   */
  public UploadImage uploadImage(java.lang.String bucketName, java.lang.String fileName) throws java.io.IOException {
    UploadImage result = new UploadImage(bucketName, fileName);
    initialize(result);
    return result;
  }

  public class UploadImage extends MyApiRequest<Void> {

    private static final String REST_PATH = "uploadImage/{bucketName}/{fileName}";

    /**
     * Create a request for the method "uploadImage".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link UploadImage#execute()} method to invoke the remote operation. <p>
     * {@link
     ...
     * @since 1.13
     */
    protected UploadImage(java.lang.String bucketName, java.lang.String fileName) {
    ...
    public UploadImage setBucketName(java.lang.String bucketName) {
    ...
    public UploadImage setFileName(java.lang.String fileName) {
